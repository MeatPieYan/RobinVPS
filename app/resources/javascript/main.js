...
(function($) {
    ...
    $window._navTo = function(content){
...
S.Drawing = (function() {
  ...
  return {
    init: function(str){
      canvas = document.querySelector(str);
...
S.ShapeBuilder = (function () {
  ...
  function fit(){
    shapeCanvas.width = Math.floor(window.innerWidth / gap / 3) * gap;
    shapeCanvas.height = Math.floor(window.innerHeight / gap / 3) * gap;
